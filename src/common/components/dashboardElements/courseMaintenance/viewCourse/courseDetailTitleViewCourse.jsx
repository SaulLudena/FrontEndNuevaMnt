...
export default function CourseDetailTitleViewCourse({ courseDetail }) {
  return (
    <div className=" relative 2xl:col-span-2 lg:col-span-1  h-full grid bg-white rounded-3xl">
      <div className="bg-[#000000] rounded-3xl ">
        <img
          ...
          alt=""
          className="w-full max-h-56 object-cover opacity-[12%] rounded-xl"
        />
        <div className="absolute top-0 w-full h-full flex items-center rounded-xl">
